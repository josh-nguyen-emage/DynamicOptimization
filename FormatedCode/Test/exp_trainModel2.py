...
# Compile the model
model.compile(optimizer='adam', loss='binary_crossentropy', metrics=[metrics.MeanSquaredError(),accuracy])
# Train the model
history = model.fit(X_train, y_train, epochs=32, batch_size=256, validation_data=(X_test, y_test))  # Adjust epochs and batch size as needed
