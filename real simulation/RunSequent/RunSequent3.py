...
def extractFile(nodeList,fileName):
    # Open the file in read mode
    dataExtracted = []
...
def ExtractResult():
    ...
    strainVal = extractFile(nodeList,"G7-Cyl-Trial-1_NODES_STRAIN.atf")
    stressVal = extractFile(nodeList,"G7-Cyl-Trial-1_NODES_STRESS.atf")
